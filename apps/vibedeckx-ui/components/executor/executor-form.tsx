...
const EXECUTOR_PRESETS: ExecutorPreset[] = [
  ...
  { name: "Tag and push", command: "Find the latest SemVer tag in the repository, increase the patch number by 1, create the new tag from the current commit, and push it to origin.", executor_type: "prompt", pty: false, description: "Bump the patch version tag and push it to origin" },
];
